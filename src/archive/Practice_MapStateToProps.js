...
//     return (
//     <div>
//     <button className="increment" onClick= {() => props.increment(props.count)}>Increment</button>
//     <button className="decrement" onClick= {() => props.decrement(props.count)}>Decrement</button>
